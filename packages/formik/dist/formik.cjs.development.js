...
var clone$1 = _interopDefault(require('lodash/clone'));
...
var FormikValuesContext = /*#__PURE__*/React.createContext(undefined);
var FormikStateContext = /*#__PURE__*/React.createContext(undefined);
var FormikMetadataContext = /*#__PURE__*/React.createContext(undefined);
var FormikMethodsContext = /*#__PURE__*/React.createContext(undefined);
...
function FormikProvider(_ref) {
  ...
  var valuesContext = React.useMemo(function () {
    return {
      values: value.values
    };
  }, [value.values]);
  var stateContext = React.useMemo(function () {
    return {
      errors: value.errors,
  ...
  var metadataContext = React.useMemo(function () {
    return {
      dirty: value.dirty,
  ...
  var methodsContext = React.useMemo(function () {
    return {
  ...
  return React.createElement(FormikMethodsContext.Provider, {
    value: methodsContext
  }, React.createElement(FormikMetadataContext.Provider, {
    value: metadataContext
  }, React.createElement(FormikStateContext.Provider, {
    value: stateContext
  }, React.createElement(FormikValuesContext.Provider, {
    value: valuesContext
  }, children))));
} // =====================================================================
...
function useFormikValues() {
  var context = React.useContext(FormikValuesContext);
  !(context !== undefined) ?  invariant(false, 'useFormikValues must be used within a <Formik> component')  : void 0;
  return context;
}
/**
...
function useFormikState() {
  var context = React.useContext(FormikStateContext);
  !(context !== undefined) ?  invariant(false, 'useFormikState must be used within a <Formik> component')  : void 0;
  return context;
}
/**
...
function useFormikMetadata() {
  var context = React.useContext(FormikMetadataContext);
  !(context !== undefined) ?  invariant(false, 'useFormikMetadata must be used within a <Formik> component')  : void 0;
  return context;
}
/**
...
function useFormikMethods() {
  var context = React.useContext(FormikMethodsContext);
  !(context !== undefined) ?  invariant(false, 'useFormikMethods must be used within a <Formik> component')  : void 0;
  return context;
} // =====================================================================
...
var FormikConsumer = function FormikConsumer(_ref2) {
  ...
  return React.createElement(React.Fragment, null, children(context));
};
/**
...
function useField(propsOrFieldName) {
  ...
  {
    !formik ?  invariant(false, 'useField() / <Field /> must be used underneath a <Formik> component')  : void 0;
  }
...
var FastField = /*#__PURE__*/React.memo(function FastField(_ref) {
  var name = _ref.name,
...
var FieldArray = /*#__PURE__*/React.memo(function FieldArray(_ref) {
  var name = _ref.name,
  ...
  var methods = useFormikMethods();
  var arrayValue = React.useMemo(function () {
    return getIn(values, name);
  }, [values, name]); // Track previous array value for validation on change

  var prevArrayValueRef = React.useRef(arrayValue); // Validate form when array changes (if validateOnChange is true)
  ...
  var updateArrayField = React.useCallback(function (fn, alterTouched, alterErrors) {
  ...
  var arrayHelpers = React.useMemo(function () {
    return {
...
var ErrorMessage = /*#__PURE__*/React.memo(function ErrorMessage(_ref) {
  var name = _ref.name,
  ...
  if (component) {
    return React.createElement(component, rest, error);
...
function SubmitButton(_ref) {
  ...
  try {
    ...
    var formStatus = React.useFormStatus == null ? void 0 : React.useFormStatus();
...
exports.useFormikMetadata = useFormikMetadata;
exports.useFormikMethods = useFormikMethods;
exports.useFormikState = useFormikState;
exports.useFormikValues = useFormikValues;
